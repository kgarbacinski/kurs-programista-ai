        ...
        <section className="container mx-auto px-4 py-12 md:py-20">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                <span className="px-4 py-2 rounded-full bg-matrix-cyan/10 border border-matrix-cyan/30 text-matrix-cyan text-sm font-medium">
                  {workshop.badge}
                </span>
              </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {workshop.forWho.personas.map((persona, idx) => (
                  ...
                  >
                    <div className="relative glass rounded-lg p-5 hover:border-matrix-cyan/30 transition-all h-full border-l-2 border-matrix-cyan/50">
            ...
            >
              ...
              <p className="text-center text-gray-400 mb-8">{workshop.learningOutcomes.subtitle}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {workshop.learningOutcomes.items.map((item, idx) => (
                  ...
                  >
                    <div className="flex justify-center mb-4 text-matrix-cyan group-hover:scale-110 transition-transform">
                      <WorkshopIcon type={item.icon} />
                    </div>
                    <h3 className="text-lg font-semibold text-white mb-3 group-hover:text-matrix-cyan transition-colors">
                      {item.title}
                    </h3>
              ...
              <div className="space-y-6">
                {workshop.syllabus.items.map((item, index) => (
                  <motion.div
                    ...
                    className="border-l-2 border-matrix-cyan/30 pl-6 py-2 group hover:border-matrix-cyan/60 transition-all"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-matrix-cyan transition-colors">
                          {item.title}
                        </h3>
                        <p className="text-gray-400 text-sm leading-relaxed">{item.description}</p>
                      </div>
            ...
            >
              <div className="relative">
                ...
                <div className="relative glass rounded-2xl p-8 md:p-12 border-matrix-cyan/40">
                  {/* Badge */}
                  <div className="flex justify-center mb-6">
                    <span className="px-4 py-2 bg-matrix-purple/20 border border-matrix-purple/50 rounded-full text-matrix-purple text-sm font-mono">
                  ...
                  {/* Highlight */}
                  <div className="bg-neural-darker/50 border border-matrix-cyan/30 rounded-lg p-6 mb-6 max-w-2xl mx-auto">
                    <p className="text-center text-matrix-cyan font-semibold">
            ...
            >
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-2 font-mono text-matrix-green">
                  {workshop.presenters.title}
                </h2>
                <p className="text-gray-400 font-mono text-sm">{workshop.presenters.subtitle}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {workshop.presenters.team.map((member, idx) => (
                  ...
                  >
                    {/* Terminal Card */}
                    <div className="relative bg-black/80 border border-matrix-cyan/30 rounded-lg p-6 hover:border-matrix-cyan/60 transition-all overflow-hidden">
                      {/* Scanline effect */}
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <span className="px-2 py-1 bg-matrix-green/20 border border-matrix-green/50 rounded text-matrix-green text-xs font-mono">
                            [{member.status}]
                          </span>
                        </div>
                        ...
                        <div className="flex justify-center mb-6">
                          <div className="relative">
                            ...
                            <motion.img
                              ...
                              className="relative w-32 h-32 rounded-full object-cover border-2 border-neural-dark group-hover:brightness-110 transition-all"
                            />
                          </div>
                        </div>
                        ...
                        <div className="text-center mb-4">
                          ...
                          <p className="text-matrix-purple font-mono text-sm">{member.title}</p>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mb-4">
                          {member.tags.map((tag, tagIdx) => (
                            <span
                              key={tagIdx}
                              className="px-2 py-1 bg-matrix-cyan/10 border border-matrix-cyan/30 rounded text-matrix-cyan text-xs font-mono"
                            >
                              [{tag}]
                            </span>
                          ))}
                        ...
                        <div className="bg-neural-darker/50 border border-matrix-cyan/20 rounded p-4">
                          <div className="font-mono text-xs text-matrix-green mb-2">
                            &gt; skills --list
                          </div>
                          <ul className="space-y-1">
                            {member.points.map((point, pointIdx) => (
                              <li key={pointIdx} className="text-gray-400 text-sm font-mono">
