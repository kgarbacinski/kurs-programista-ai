          ...
          <div className="relative glass rounded-lg p-5 sm:p-6 md:p-8">
            ...
            <Link href="#purchase" className="focus:outline-none focus:ring-2 focus:ring-matrix-cyan focus:ring-offset-2 focus:ring-offset-black rounded-lg">
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-2 bg-gradient-to-r from-matrix-cyan to-matrix-purple hover:from-matrix-cyan/80 hover:to-matrix-purple/80 text-white font-bold py-3 md:py-4 px-5 sm:px-6 md:px-8 rounded-lg transition-all text-sm sm:text-base">
